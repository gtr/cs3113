...
enum EntityType { PLATFORM, PLAYER, ENEMY, FIRE  };
enum AIType     { WALKER, GUARD, FLY, SHOOT      };
enum AIState    { WALKING, IDLE, ATTACKING, FLY_UP, FLY_DOWN, WALK_LEFT, WALK_RIGHT };
...
public:
    ...
    void update(float delta_time, Entity *player, Entity* fire, Entity *collidable_entities, int collidable_entity_count);
    ...
    void const check_collision_player(Entity* entity);
